...
int char_array5(){
	...
	printf("p[2] is %c\n\n",*(p+2)); //2 method to get the element value
        ...
        char *q="abcdef";  //right
	printf("char q is %s\n",q);
	printf("sizeof(q) is %ld\n",sizeof(q));
       	printf("strlen(q) is %ld\n\n",strlen(q));
	printf("q[0] is %c\n",*q );
	printf("q[1] is %c\n",q[1]);
...
int char_array6(){
	...
	printf("sizeof(q) is %ld\n",sizeof(q));
	printf("sizeof(r) is %ld\n\n",sizeof(r));

	printf("sizeof(int) is %ld\n\n",sizeof(int));
	printf("sizeof(long) is %ld\n\n",sizeof(long));
	printf("sizeof(char) is %ld\n\n",sizeof(char));

	printf("getlen(c) is %ld\n",getlen(c));
	printf("getlen(p) is %ld\n\n",getlen(p));
